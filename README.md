...
- **Subdomain Discovery**: Uses `subfinder` and `assetfinder` (with optional `amass` support)
...
1. **Subdomain Discovery**: Finds subdomains using subfinder, assetfinder, and optionally amass
